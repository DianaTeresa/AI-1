...
def level_1(maps):
    ...
    for obj in maps:
        ...
        ap.PGAME(graph, start, goal, wayoutDFS,bonus_points, portals, openDFS,dir_path,path)
        ...
        ap.PGAME(graph, start, goal, wayoutBFS,bonus_points, portals, openBFS,dir_path,path)'''
        ...
        ap.PGAME(graph, start, goal, wayoutUCS,bonus_points, portals, openUCS,dir_path,path)
        ...
        ap.PGAME(graph, start, goal, wayoutGBFS_1,bonus_points, portals, openGBFS_1,dir_path,path)
        ...
        ap.PGAME(graph, start, goal, wayoutGBFS_2,bonus_points, portals, openGBFS_2,dir_path,path)
        ...
        ap.PGAME(graph, start, goal, wayoutAstar_1,bonus_points, portals, openAstar_1,dir_path,path)
        ...
        ap.PGAME(graph, start, goal, wayoutAstar_2,bonus_points, portals, openAstar_2,dir_path,path)'''
        mapID += 1
...
def level_2(maps):
    ...
    for obj in maps:
        ...
        ap.PGAME(graph, start, goal, wayout,bonus_points, portals, openSet,dir_path,path)
...
def advance(maps):
    ...
    for obj in maps:
        ...
        ap.PGAME(graph, start, goal, wayout,bonus_points, portals, open,dir_path,path)
        mapID += 1
    pass
